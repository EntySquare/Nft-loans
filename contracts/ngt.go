...
// LoansList is a paid mutator transaction binding the contract method 0x4fe7abba.
//
// Solidity: function loansList(uint256 start, uint256 limit, address user) returns(uint256[])
func (_Contracts *ContractsTransactor) LoansList(opts *bind.TransactOpts, start *big.Int, limit *big.Int, user common.Address) (*types.Transaction, error) {
	return _Contracts.contract.Transact(opts, "loansList", start, limit, user)
}

// LoansList is a paid mutator transaction binding the contract method 0x4fe7abba.
//
// Solidity: function loansList(uint256 start, uint256 limit, address user) returns(uint256[])
func (_Contracts *ContractsSession) LoansList(start *big.Int, limit *big.Int, user common.Address) (*types.Transaction, error) {
	return _Contracts.Contract.LoansList(&_Contracts.TransactOpts, start, limit, user)
}

// LoansList is a paid mutator transaction binding the contract method 0x4fe7abba.
//
// Solidity: function loansList(uint256 start, uint256 limit, address user) returns(uint256[])
func (_Contracts *ContractsTransactorSession) LoansList(start *big.Int, limit *big.Int, user common.Address) (*types.Transaction, error) {
	return _Contracts.Contract.LoansList(&_Contracts.TransactOpts, start, limit, user)
}
